...
```bash
fromagerie-virtuelle-inscription$ sam build --use-container
```
...
```bash
fromagerie-virtuelle-inscription$ sam local invoke HelloWorldFunction --event events/event.json
```
...
```bash
fromagerie-virtuelle-inscription$ sam logs -n HelloWorldFunction --stack-name fromagerie-virtuelle-inscription --tail
```
...
```bash
fromagerie-virtuelle-inscription$ pip install -r tests/requirements.txt --user
# unit test
fromagerie-virtuelle-inscription$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
fromagerie-virtuelle-inscription$ AWS_SAM_STACK_NAME=<stack-name> python -m pytest tests/integration -v
```
...
```bash
sam delete --stack-name fromagerie-virtuelle-inscription
```
